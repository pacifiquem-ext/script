    ...
    <section className="py-32 bg-white max-sm:py-20" id="services">
      <div className="container">
        ...
        <div className="grid grid-cols-2 max-sm:grid-cols-1 gap-px bg-neutral-200">
          {FEATURES.map((feat, i) => (
            <div key={i} className="flex flex-col gap-3 px-8 py-10 bg-white transition-colors duration-200 cursor-default hover:bg-neutral-25 group">
              <div className="flex items-center justify-center w-10 h-10 bg-primary-base text-white rounded-10 shrink-0 transition-transform duration-250 group-hover:-rotate-6 group-hover:scale-110">{feat.icon}</div>
