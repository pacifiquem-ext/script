          ...
          <div className="bg-white rounded-16 shadow-[0_0_0_1px_theme(colors.neutral.200),theme(boxShadow.lg)] overflow-hidden transition-shadow duration-200 flex flex-col focus-within:shadow-[0_0_0_1.5px_theme(colors.neutral.950),theme(boxShadow.xl)]">
            ...
            <div className="flex items-center justify-between px-4 py-3 border-t border-neutral-200 bg-neutral-50">
              <div className="flex items-center gap-1">
                <button className="flex items-center justify-center w-[34px] h-[34px] border-none bg-transparent text-neutral-400 cursor-pointer rounded-8 transition-all duration-200 hover:text-neutral-600 hover:bg-neutral-50 hover:-rotate-12 hover:scale-110" aria-label="Attach file">
                  <IconAttach size={18} />
                </button>
