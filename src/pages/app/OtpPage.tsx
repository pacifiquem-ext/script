      ...
      <div className="w-full max-w-[400px] p-8 flex flex-col gap-6 relative z-20">
        ...
        <p className="text-para-sm text-neutral-600 text-center">
          ...
          {resent
            ...
            : <button className="bg-transparent border-none cursor-pointer font-sans text-para-sm text-primary-base font-medium p-0 transition-colors hover:text-primary-darker" onClick={handleResend}>Resend code</button>
          }
        </p>
      </div>
    </div>
