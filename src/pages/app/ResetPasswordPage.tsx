    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-[24px_16px] bg-white relative overflow-hidden">
      ...
      <div className="w-full max-w-[400px] p-8 flex flex-col gap-6 relative z-20">
        ...
        <div className="text-center flex flex-col gap-1">
          ...
          <p className="text-para-sm text-neutral-600">Choose a strong password for your account.</p>
        </div>
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <Input
            ...
            leftIcon={<IconLockPassword size={18} />}
            rightIcon={
              <button type="button" onClick={() => setShowConfirm(v => !v)} className="bg-transparent border-none cursor-pointer text-neutral-400 flex items-center p-0 transition-colors hover:text-neutral-600" aria-label="Toggle confirm">
