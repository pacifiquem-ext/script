...
export function Hero() {
  return (
    <section className="pt-[120px] pb-0 overflow-hidden relative max-sm:pt-[96px]">
      <div
        className="absolute inset-0 bg-[radial-gradient(circle,theme(colors.neutral.200)_1px,transparent_1px)] bg-[size:32px_32px] opacity-50 pointer-events-none after:content-[''] after:absolute after:inset-0 after:bg-[radial-gradient(ellipse_80%_60%_at_50%_0%,transparent_40%,theme(colors.neutral.0)_100%)]"
        aria-hidden
      />
      ...
      <div className="container flex flex-col items-center text-center gap-6 pb-16 relative z-10">
        ...
        <h1 className="max-w-[720px] animate-[fadeInUp_0.5s_0.1s_ease_both] text-h1">
          ...
          <br />
          <span className="bg-[linear-gradient(135deg,theme(colors.neutral.950)_0%,theme(colors.neutral.500)_100%)] bg-clip-text text-transparent [-webkit-text-fill-color:transparent]">
            documents in seconds.
          </span>
        </h1>

        <p className="max-w-[520px] text-neutral-600 animate-[fadeInUp_0.5s_0.2s_ease_both] text-para-lg">
          Stop searching through folders, emails, and spreadsheets. Upload your documents and get
          instant answers, summaries, and key details&mdash;when you need them.
        </p>
          ...
          <div className="rounded-16 overflow-hidden shadow-[0_0_0_1px_theme(colors.neutral.200),theme(boxShadow.2xl)] bg-neutral-50">
            ...
            <div className="relative aspect-video overflow-hidden group">
              ...
              <div className="absolute inset-0 bg-black/30 flex items-center justify-center transition-colors duration-300 group-hover:bg-black/20">
                <button
                  className="w-16 h-16 rounded-full bg-white/95 border-none cursor-pointer flex items-center justify-center text-neutral-950 transition-all duration-200 shadow-lg hover:scale-105 hover:bg-white"
