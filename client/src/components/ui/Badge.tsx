...
export function Badge({
  ...
  const variantStyles = {
    ...
    success:
      'bg-success-lighter text-success-base shadow-[inset_0_0_0_1px_theme(colors.success.light)]',
    warning:
      'bg-warning-lighter text-warning-base shadow-[inset_0_0_0_1px_theme(colors.warning.light)]',
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 font-medium rounded-full whitespace-nowrap ${sizeStyles[size]} ${variantStyles[variant]} ${className}`}
    >
