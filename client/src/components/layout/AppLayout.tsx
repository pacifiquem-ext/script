    ...
    <div className="flex h-screen overflow-hidden bg-white">
      ...
      >
        ...
        <div className="flex flex-col gap-0.5 p-[10px_8px_6px] shrink-0">
          ...
          <Link
            to="/app/connectors"
            className={`flex items-center gap-2.5 p-[7px_8px] border-none cursor-pointer rounded-8 no-underline transition-colors whitespace-nowrap overflow-hidden ${isActive('/app/connectors') ? 'text-neutral-950 bg-neutral-200' : 'bg-transparent text-neutral-400 hover:text-neutral-950 hover:bg-neutral-50'}`}
            title="Connectors"
          >
