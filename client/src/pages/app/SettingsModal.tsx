                ...
                <div className="flex-1 flex flex-col gap-6 w-full max-w-[500px]">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        <p className="text-[14px] font-medium text-neutral-950">
                          James Brown{' '}
                          <span className="text-neutral-400 font-normal">(james@gmail.com)</span>
                        </p>
                        <p className="text-[12px] text-neutral-400 mt-0.5">
                          Member since{' '}
                          <span className="text-neutral-950 font-medium">May 16, 2025</span>
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-y-4 gap-x-8 mt-2">
                    <div className="flex flex-col gap-1">
                      ...
                      <span className="text-[14px] font-medium text-neutral-950">Spectrum™</span>
                    </div>
                    <div className="flex flex-col gap-1">
              ...
              <div className="py-8 border-t border-neutral-200 flex items-start gap-12 max-lg:flex-col max-lg:gap-6">
                ...
                <div className="flex-1 flex flex-col gap-6 w-full max-w-[500px]">
                  ...
                  <div className="grid grid-cols-[140px_1fr] gap-y-4 gap-x-8 mt-2 border-t border-neutral-100 pt-6">
                    ...
                    <div className="flex flex-col gap-1">
                      <span className="text-[14px] font-medium text-neutral-950">James Brown</span>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <div className="flex-1 flex flex-col gap-6 w-full max-w-[500px]">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-[12px] text-neutral-400">
                        Preferred file format for exports
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4 px-3 py-1.5 border border-neutral-200 rounded-8 bg-white text-[13px] text-neutral-700">
                      <span className="text-neutral-400 cursor-pointer hover:text-neutral-950">
                        -
                      </span>
                      <span>30</span>
                      <span className="text-neutral-400 cursor-pointer hover:text-neutral-950">
            ...
            <div className="px-[40px] pb-[40px] flex flex-col">
              <div className="py-8 border-t border-neutral-200 flex items-start gap-12 max-lg:flex-col max-lg:gap-6">
                ...
                <div className="flex-1 flex flex-col gap-6 w-full max-w-[500px]">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        ...
                        <p className="text-[12px] text-neutral-400 mt-0.5">
                          Team created date{' '}
                          <span className="text-neutral-950 font-medium">May 18, 2025</span>
                        </p>
                      </div>
                    </div>
                    <button className="px-4 py-1.5 border border-neutral-200 rounded-8 bg-white text-[13px] font-medium text-neutral-700 hover:bg-neutral-50 transition-colors">
                  ...
                  <div className="grid grid-cols-[140px_1fr] gap-y-4 gap-x-8 mt-2 border-t border-neutral-100 pt-6">
                    <div className="flex flex-col gap-1">
                      <span className="text-[13px] text-neutral-500">Used seats</span>
                    </div>
                    <div className="flex flex-col gap-1">
                      <span className="text-[14px] font-medium text-neutral-950">3/10 seats</span>
                    </div>
                    <div className="flex flex-col gap-1">
                      <span className="text-[13px] text-neutral-500">Admins</span>
                    </div>
                    <div className="flex flex-col gap-1">
                      <span className="text-[14px] font-medium text-neutral-950">2 members</span>
                    </div>
                    <div className="flex flex-col gap-1">
                      <span className="text-[13px] text-neutral-500">Pending invites</span>
                    </div>
                    <div className="flex flex-col gap-1">
                      <span className="text-[14px] font-medium text-neutral-950">1 invite</span>
                    </div>
                    <div className="flex flex-col gap-1">
                      <span className="text-[13px] text-neutral-500">Active today</span>
                    </div>
                    <div className="flex flex-col gap-1">
                      <span className="text-[14px] font-medium text-neutral-950">3 members</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="flex-1 flex flex-col gap-5 w-full max-w-[500px]">
                  ...
                  <div className="flex flex-col gap-0 border-t border-neutral-100 mt-2 pt-2">
                    {[
                      ...
                      <div
                        key={i}
                        className="flex flex-col py-4 border-b border-neutral-100 last:border-0 gap-3"
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <div
                              className={`w-8 h-8 rounded-full flex items-center justify-center text-[11px] font-bold shrink-0 ${user.color}`}
                            >
                              {user.initial}
                            </div>
                            <div className="flex flex-col">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button className="p-1.5 text-neutral-400 hover:text-error-base transition-colors">
                              <IconClose size={14} />
                            </button>
                          </div>
                        </div>
