...
const INITIAL_FOLDERS: FolderItem[] = [
  {
    ...
    files: [
      {
        id: 'f1',
        name: 'Supplier Agreement – March 2026.pdf',
        type: 'pdf',
        size: '2.4 MB',
        date: 'Mar 12, 2026',
        folder: 'Contracts',
  ...
  },
  {
    ...
    files: [
      {
        id: 'f6',
        name: 'Q1 2026 Financial Summary.xls',
        type: 'xls',
        size: '1.8 MB',
        date: 'Apr 1, 2026',
        folder: 'Reports',
      ...
      {
        id: 'f7',
        name: 'Usability Testing Results.doc',
        type: 'doc',
        size: '720 KB',
        date: 'Mar 20, 2026',
        folder: 'Reports',
    ...
    <div className="w-[60px] h-[72px] relative shrink-0">
      <div className="w-full h-full bg-white border-[1.5px] border-neutral-200 rounded-6 relative flex items-center justify-center shadow-sm">
        ...
        <span
          ...
          style={{ color: TYPE_COLOR[type] || '#737373' }}
        >
...
export function LibraryPage() {
  ...
  const [uploadSource, setUploadSource] = useState<
    'local' | 'drive' | 'dropbox' | 'onedrive' | 'box' | 'url' | 'api'
  >('local');
  ...
  const handleChatSubmit = () => {
    ...
    navigate('/app/chat', {
      state: {
        ...
        quotedFiles: quotedFiles.map((f) => ({ id: f.id, name: f.name, type: f.type })),
      },
    });
  };
  ...
  const handleCreateFolderSubmit = () => {
    if (newFolderName.trim()) {
      setFolders([
        ...folders,
        { id: Date.now().toString(), name: newFolderName.trim(), count: 0, files: [] },
      ]);
    }
  ...
  const handleDelete = (id: string, type: 'file' | 'folder') => {
    if (type === 'folder') {
      ...
      if (openFolder) {
        setOpenFolder({
          ...openFolder,
          files: openFolder.files.filter((file) => file.id !== id),
          count: openFolder.files.length - 1,
        });
      }
    }
  };
  ...
  const handleDrop = (e: React.DragEvent) => {
    e.preventDefault();
    setIsDragging(false); /* Handled in a real app */
  };
      ...
      >
        ...
        <div className="flex flex-col gap-3 relative z-20">
          <div className="flex items-center justify-between">
            <nav className="flex items-center gap-1.5" aria-label="breadcrumb">
              ...
              {openFolder && (
                <>
                  ...
                  <span className="text-neutral-950 font-medium text-para-sm">
                    {openFolder.name}
                  </span>
                </>
              )}
            ...
            <div className="flex items-center gap-3">
              ...
              {!openFolder && (
                <button
                  className="inline-flex items-center justify-center gap-2 h-8 px-3 rounded-8 font-medium font-sans text-xs transition-colors bg-white border border-neutral-200 text-neutral-950 shadow-sm hover:bg-neutral-50"
          ...
          <div className="relative flex items-center">
            ...
            <input
              ...
              type="text"
              placeholder={
                openFolder ? `Search in ${openFolder.name}…` : 'Search files and folders…'
              }
              value={search}
              ...
              <div className="grid grid-cols-[repeat(auto-fill,minmax(160px,1fr))] gap-4 max-md:grid-cols-[repeat(auto-fill,minmax(130px,1fr))]">
                ...
                {displayFolders.map((folder) => (
                  ...
                  >
                    ...
                    <p className="text-label-sm text-neutral-950 mt-[2px] truncate w-full px-2">
                      {folder.name}
                    </p>
        ...
        <section className="flex flex-col gap-4 relative z-20">
          <h2 className="text-label-lg text-neutral-950">
            ...
            {search && (
              <span className="text-neutral-400 text-para-xs">
                {' '}
            ...
            <div className="grid grid-cols-[repeat(auto-fill,minmax(140px,1fr))] gap-4">
              {displayFiles.map((file) => (
                ...
                >
                  ...
                  <p className="text-label-sm text-neutral-950 text-[12px] break-words leading-[1.4] max-w-[120px] line-clamp-2">
                    {file.name}
                  </p>
            ...
            <div className="flex flex-col border border-neutral-200 rounded-12 overflow-hidden bg-white">
              {displayFiles.map((file) => (
                ...
                >
                  ...
                  <span className="text-para-xs text-neutral-400 w-24 hidden md:block">
                    {file.size}
                  </span>
                  <span className="text-para-xs text-neutral-400 w-24 hidden md:block">
                    {file.date}
        ...
        {contextMenu && (
          <div className="fixed inset-0 z-[300]" onClick={() => setContextMenu(null)}>
            ...
            >
              <p className="text-subheading-sm text-neutral-400 px-2 pt-2 pb-1 truncate max-w-[140px]">
        ...
        {previewFile && (
          <>
            <div
              className="fixed inset-0 bg-black/30 z-[200] animate-[fadeIn_0.2s_ease]"
            ...
            <div className="relative bg-white rounded-20 shadow-2xl w-full max-w-[840px] h-[min(640px,90vh)] flex overflow-hidden animate-[fadeUp_0.4s_cubic-bezier(0.16,1,0.3,1)]">
              ...
              <div className="w-[200px] bg-neutral-50 border-r border-neutral-200 flex flex-col p-4 gap-6 shrink-0">
                <div className="flex flex-col gap-1">
                  <h3 className="text-para-xs font-bold text-neutral-400 uppercase tracking-wider px-2">
                    Sources
                  </h3>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {uploadSource !== 'local' &&
                      ...
                      isConnected[uploadSource] && (
                        <span className="px-2 py-0.5 bg-green-50 text-[10px] text-green-600 font-bold rounded-full border border-green-100">
                          CONNECTED
                        </span>
                      )}
                  </div>
                  <button
                    className="p-1 text-neutral-400 hover:text-neutral-950 transition-colors bg-transparent border-none rounded-8 hover:bg-neutral-100"
                    onClick={() => setIsUploadModalOpen(false)}
                  >
                    <IconClose size={20} />
                  </button>
                  ...
                  {uploadSource === 'local' ? (
                    ...
                    <div className="flex flex-col gap-6">
                      <div className="border-2 border-dashed border-neutral-200 rounded-20 p-12 flex flex-col items-center justify-center gap-4 text-center transition-all hover:border-primary-base hover:bg-primary-alpha-5 group cursor-pointer">
                        ...
                        <div>
                          <p className="text-label-lg text-neutral-950 font-bold">
                            <span className="text-primary-base">Click to browse</span> or drag and
                            drop
                          </p>
                          <p className="text-para-sm text-neutral-500 mt-1">
                            PDF, DOC, XLS, CSV up to 50MB per file
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 max-w-[480px] mx-auto w-full pt-12">
                      ...
                      <div className="flex flex-col gap-2">
                        <label className="text-label-sm text-neutral-700 font-medium">
                          Document URL
                        </label>
                        <input
                    ...
                    <div className="flex flex-col gap-4 max-w-[480px] mx-auto w-full pt-12">
                      ...
                      <div className="text-center mb-6">
                        ...
                        <p className="text-para-sm text-neutral-500 mt-1">
                          Build custom integrations using our secure API. Generate keys to get
                          started.
                        </p>
                      </div>
                      ...
                      {!isConnected[uploadSource] ? (
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center text-center gap-6 animate-[fadeIn_0.3s_ease]">
                          ...
                          <div className="max-w-[320px]">
                            <h3 className="text-h6 text-neutral-950 font-bold">
                              Connect your {uploadSource}
                            </h3>
                            <p className="text-para-sm text-neutral-500 mt-2 leading-relaxed">
                              Access your {uploadSource} folders and import documents directly into
                              your library.
                            </p>
                          </div>
                          <Button
                        ...
                        <div className="flex-1 flex flex-col min-h-0 animate-[fadeIn_0.3s_ease]">
                          <div className="flex items-center gap-3 mb-6">
                            ...
                            <div className="flex items-center gap-1.5 p-1 bg-neutral-100 rounded-8">
                              <button className="p-1.5 bg-white shadow-xs rounded-6 text-neutral-950">
                                <IconGrid size={14} />
                              </button>
                          ...
                          <div className="flex-1 overflow-y-auto pr-2 flex flex-col gap-1">
                            {CLOUD_FILES.filter((f) =>
                              ...
                              <div key={item.id} className="flex flex-col">
                                ...
                                >
                                  <div
                                    className={`w-5 h-5 rounded-6 border flex items-center justify-center transition-all ${selectedCloudFiles.has(item.id) ? 'bg-primary-base border-primary-base text-white' : 'border-neutral-300 bg-white group-hover:border-neutral-400'}`}
                                  >
                                  ...
                                  {item.type === 'folder' ? (
                                    <div className="flex items-center gap-2 flex-1 min-w-0">
                                      ...
                                      />
                                      <span className="text-label-sm text-neutral-950 font-bold truncate">
                                        {item.name}
                                      </span>
                                      <IconChevronDown
                                        size={14}
                                    ...
                                    <div className="flex items-center gap-2 flex-1 min-w-0">
                                      ...
                                      <span className="text-label-sm text-neutral-950 truncate">
                                        {item.name}
                                      </span>
                                      <span className="text-para-xs text-neutral-400 ml-auto whitespace-nowrap">
                                        {item.size}
                                      </span>
                                    </div>
                                  )}
                                  ...
                                  <div className="ml-8 mt-0.5 mb-1 flex flex-col gap-0.5 border-l border-neutral-100">
                                    {item.items.map((subItem) => (
                                      <div
                                        ...
                                        onClick={(e) => {
                                          e.stopPropagation();
                                          toggleCloudFile(subItem.id);
                                        }}
                                      >
                                        <div
                                          className={`w-4 h-4 rounded-4 border flex items-center justify-center transition-all ${selectedCloudFiles.has(subItem.id) ? 'bg-primary-base border-primary-base text-white' : 'border-neutral-300 bg-white group-hover:border-neutral-400'}`}
                                        >
                                          {selectedCloudFiles.has(subItem.id) && (
                                            <IconCheck size={10} />
                                          )}
                                        </div>
                                        <IconDocFile
                                        ...
                                        />
                                        <span className="text-para-sm text-neutral-700 truncate">
                                          {subItem.name}
                                        </span>
                                        <span className="text-para-xs text-neutral-400 ml-auto whitespace-nowrap">
                                          {subItem.size}
                ...
                <div className="p-4 border-t border-neutral-100 bg-neutral-50/50 flex flex-col gap-3">
                  {isImporting && (
                    <div className="flex flex-col gap-2 animate-[fadeUp_0.2s_ease]">
                      <div className="flex items-center justify-between">
                        <span className="text-para-xs font-bold text-primary-base">
                          Importing {selectedCloudFiles.size} files...
                        </span>
                        <span className="text-para-xs font-bold text-neutral-950">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      {uploadSource !== 'local' && isConnected[uploadSource] && (
                        <button
                          className="text-para-xs text-neutral-400 hover:text-error-base transition-colors font-medium underline underline-offset-2"
                          onClick={() =>
                            setIsConnected((prev) => ({ ...prev, [uploadSource]: false }))
                          }
                        >
                          Disconnect account
                        </button>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      >
                        {selectedCloudFiles.size > 0
                          ? `Import ${selectedCloudFiles.size} files`
                          : 'Upload'}
                      </Button>
                    </div>
                  </div>
          ...
          >
            <div className="flex items-center gap-2 px-3 pt-1 pb-1">
              ...
              <span className="text-[13px] text-neutral-600 font-medium">
                ...
                <span className="text-primary-base font-semibold">1,450</span> credits
              </span>
              ...
              <div className="flex items-center justify-between p-[8px_12px_12px_12px]">
                <div className="flex items-center gap-1">
                  ...
                  {quotedFiles.map((f) => (
                    <span
                      key={f.id}
                      className="inline-flex items-center gap-[5px] px-[8px] py-[3px] bg-white border border-neutral-200 rounded-full text-[11px] font-medium text-neutral-600 whitespace-nowrap max-w-[180px] overflow-hidden animate-[fadeUp_0.15s_ease]"
                    >
                      <span
                        className="w-1.5 h-1.5 rounded-full shrink-0"
                        style={{ background: TYPE_COLOR[f.type] || '#737373' }}
                      />
                      <IconDocFile size={12} />
