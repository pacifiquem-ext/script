...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'primary-gradient': 'linear-gradient(180deg, rgba(255,255,255,0.18) 0%, rgba(255,255,255,0) 100%), #00B258',
        'primary-gradient-hover': 'linear-gradient(180deg, rgba(255,255,255,0.18) 0%, rgba(255,255,255,0) 100%), #009348',
      },
      keyframes: {
        fadeInUp: {
